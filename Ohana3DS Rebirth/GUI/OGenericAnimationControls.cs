        ...
        private void BtnExport_Click(object sender, EventArgs e)
        {
            switch (type)
            {
                case FileIO.fileType.skeletalAnimation:
                    ...
                    {
                        MessageBox.Show("A skeleton is necessary to export a Skeletal Animation." + Environment.NewLine + "You must select a model before exporting!", "Warning", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                        return;
                    }
